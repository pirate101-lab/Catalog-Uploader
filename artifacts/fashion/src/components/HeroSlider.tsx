            ...
            >
              ...
              <Caption.Ctas>
                <Link
                  ...
                  className="inline-flex items-center gap-1 min-w-0 bg-white text-black hover:bg-primary hover:text-primary-foreground px-2.5 h-9 rounded-full text-[10px] tracking-widest uppercase font-bold whitespace-nowrap shadow-md shadow-black/20 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300"
